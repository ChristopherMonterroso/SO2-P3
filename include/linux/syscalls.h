...
// --------------------------------------------------------------------- Llamada 3
asmlinkage long sys_get_io_throttle(pid_t pid, struct io_stats __user *user_stats);

// --------------------------------------------------------------------- Llamada 1
asmlinkage long sys_tamalloc(size_t size);
// --------------------------------------------------------------------- Llamada 2
asmlinkage long sys_memory_usage_table(pid_t pid, struct memory_stats __user *stats);
// --------------------------------------------------------------------- Llamada 3
asmlinkage long sys_memory_usage_general(struct global_memory_stats __user *stats);

// --------------------------------------------------------------------- Llamada 1
asmlinkage long SYS_CHRIS_ADD_MEMORY_LIMIT(pid_t process_pid, size_t memory_limit);
// --------------------------------------------------------------------- Llamada 2
asmlinkage long SYS_CHRIS_GET_MEMORY_LIMITS(struct memory_limitation __user *buffer, size_t max_entries, size_t __user *processes_returned);
// --------------------------------------------------------------------- Llamada 3
asmlinkage long SYS_CHRIS_UPDATE_MEMORY_LIMIT(pid_t process_pid, size_t memory_limit);
// --------------------------------------------------------------------- Llamada 4
asmlinkage long SYS_CHRIS_REMOVE_MEMORY_LIMIT(pid_t process_pid);
